...
#if MANIA_USE_PLUS
void TimeAttackData_TrackActClear_Hook(StatInfo *stat, uint8 zone, uint8 act, uint8 characterID, int32 time, int32 rings, int32 score)
{
    stat->statID = 0;
    stat->name   = "ACT_CLEAR";
...
uint32 TimeAttackData_GetPackedTime_Hook(int32 minutes, int32 seconds, int32 milliseconds) { return 6000 * minutes + 100 * seconds + milliseconds; }
